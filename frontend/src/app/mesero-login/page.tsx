...
export default function MeseroLoginPage() {
  ...
  const [email, setEmail] = useState('mesero@barranco.com')
  ...
  const handleEmailSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (user.rol !== 'mesero') {
        throw new Error('No tienes permisos de mesero')
      }
          ...
          <CardContent>
            {step === 'email' ? (
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      id="email"
                      type="email"
                      placeholder="mesero@barranco.com"
                      className="pl-10"
                      value={email}
              ...
              <form onSubmit={handleCodigoSubmit} className="space-y-4">
                ...
                <Button type="submit" className="w-full bg-orange-600 hover:bg-orange-700 text-white" disabled={loading || codigo.length < 6}>
