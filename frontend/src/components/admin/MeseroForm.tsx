...
export default function MeseroForm({ onSuccess, onCancel }: MeseroFormProps) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="nombre" placeholder="María" className="pl-9" {...register('nombre')} />
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <User className="absolute left-3 top-2.5 h-4 w-4 text-gray-400" />
                <Input id="apellido" placeholder="González" className="pl-9" {...register('apellido')} />
              </div>
